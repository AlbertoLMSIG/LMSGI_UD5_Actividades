        ...
        <xsl:for-each select="CDs/CD">
                        ...
                        <xsl:variable name="Año_de_publicación">
                            ...
                            <xsl:for-each select="Cancion">
                                <xsl:if test="@tiempo &lt; 50">
                                    <tr text-align="center">
                                    <td><xsl:value-of select="$Título_del_album"/></td>
                                    <td><xsl:value-of select="$Sello_discográfico"/></td>
                                    <td><xsl:value-of select="$Año_de_publicación"/></td>
